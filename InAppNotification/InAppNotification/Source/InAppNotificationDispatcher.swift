//
//  InAppNotificationDispatcher.swift
//  InAppNotificationDemo
//
//  Created by Arnold Plakolli on 5/17/18.
...
public class InAppNotificationDispatcher {
    ...
    private func hideBanner(animated: Bool, _ completion: @escaping () -> ()) {
        bannerConstraints[0].constant = -InAppNotificationBanner.height
        animator?.stopAnimation(true)
    ...
    private func setupBannerConstraints(banner: InAppNotificationBanner, bannerWindow: UIWindow) -> [NSLayoutConstraint] {
        ...
        if #available(iOS 11.0, *) {
            ...
            constraints.append(banner.leadingAnchor.constraint(equalTo: bannerWindow.safeAreaLayoutGuide.leadingAnchor, constant: 20))
            constraints.append(banner.trailingAnchor.constraint(equalTo: bannerWindow.safeAreaLayoutGuide.trailingAnchor, constant: -20))
